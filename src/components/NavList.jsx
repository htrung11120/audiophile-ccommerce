...
export default function NavList() {
  ...
  return (
    <div className="mb-12 flex w-full flex-col items-center justify-center gap-4 text-[13px] font-bold uppercase leading-[25px] tracking-[2px] text-white sm:flex-row sm:gap-9 lg:mb-0  lg:gap-20">
