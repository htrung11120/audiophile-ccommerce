  ...
  return (
    <div className="flex flex-wrap ">
      <div className="flex w-full flex-row items-center justify-between border-b border-white/20 px-6 py-8 sm:mx-10 sm:px-0 lg:mx-[10.5rem] lg:py-10">
        <GiHamburgerMenu
          className="h-6 w-6 cursor-pointer fill-white hover:fill-[#D87D4A] sm:mr-11 sm:h-8 md:w-8  lg:hidden"
        ...
        <div className="sm:ml-auto lg:ml-0">
          <AiOutlineShoppingCart
            className="h-6 w-6  cursor-pointer fill-white hover:fill-[#D87D4A] md:h-8 md:w-8 "
