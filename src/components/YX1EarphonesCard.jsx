...
export default function YX1EarphonesCard() {
  ...
  return (
    <div className="mt-6 flex flex-col gap-6 sm:mx-10 sm:flex-row lg:mx-[165px]">
      <div className="mx-6 h-52 rounded-lg bg-[url(/src/assets/home/mobile/image-earphones-yx1.jpg)] bg-contain sm:mx-0  sm:h-[320px] sm:flex-grow sm:bg-[url(/src/assets/home/tablet/image-earphones-yx1.jpg)] sm:bg-cover lg:w-[540px] lg:grow lg:bg-[url(/src/assets/home/desktop/image-earphones-yx1.jpg)]"></div>
